...
export default function ProveedorPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    // Solicitudes abiertas que coinciden
    if (comunas.length > 0 && categoryIds.length > 0) {
      ...
      // Filtrar solicitudes donde este proveedor no ha enviado propuesta
    ...
    // Obtener propuestas aceptadas del proveedor
    ...
    const { data: bookingsData, error: bookingErr } = propuestaIds.length > 0 ? await supabase
      .from('bookings')
